...
(function() {
  ...
  const VIEW_INFO = {
    ...
    klassenlive:  { icon:'fa-medal', t:'Klassen Live', d:'Drei Normen mit Live-Animationen: SÜ-Objekte, EMA-Alarmwellen, RC-Tür mit Einbruchs-Simulation. Pyramide, Schieber, Vergleichs-Grid.' },
